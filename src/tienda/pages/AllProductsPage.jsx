...
export const AllProductsPage = () => {
    ...
    const changeLanguage = (language) => {
      ...
      useEffect(() => {
        const fetchData = async () => {
            try {
                const response = await fetch(`https://arkusnexustest.myshopline.com/admin/openapi/v20240601/products/products.json?lang=${i18n.language}`, {
                    headers: {
               ...
               setItems(data?.products?.filter((product) => product.product_category === "Bathroom Suites"));
  ...
  return (
    <>
        ...
        <div className='container ' style={{
          ...
          <div className="row mt-3">
            ...
            <div className="col-2 d-flex justify-content-center">
              <select value={sortType} onChange={(e) => setSortType(e.target.value)} className="form-select">
      ...
      <p>{t('keyForYourText')}</p> {/* 'keyForYourText' es la clave en tus archivos de traducción */}
    </div>
          </div>
        ...
        <div style={{ 
              ...
              padding: "10px",
              marginTop: "15px",
              marginBottom:"15px"}} className=''>
<div className='container'>
            <div className='row mt-5'>
                {currentItems.map((product) => {

                    return(
                        <div className="col-xl-3 col-lg-4 col-md-6" style={{marginBottom:"50px"}} key={product.id}>
